...
def main(config_file):
    ...
    model = set_VQModel(config, load_name)
    print('Done')
    ...
    save_grid_imgs(unscale_tensor(x_original), x_original.shape[0] // 2, f'{img_folder}/original-images.jpg')
    ...
    for epoch in range(num_epochs):
        ...
        for bstep, X in enumerate(progress_bar):
            ...
            if step != 0 and (step+1) % sample_every == 0:
                ...
                save_grid_imgs(x_recon, x_recon.shape[0] // 2, f'{img_folder}/recon_imgs-{step+1}-{epoch+1}.jpg')
